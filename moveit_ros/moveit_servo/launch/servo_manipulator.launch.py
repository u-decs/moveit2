...
def generate_launch_description():
    moveit_config = (
        ...
        .robot_description(file_path="config/manipulator_2.urdf.xacro")
        .to_moveit_configs()
    )

    # Get parameters for the Servo node
    servo_yaml = load_yaml("moveit_servo", "config/manipulator_2_simulated_config.yaml")
    servo_params = {"moveit_servo": servo_yaml}

    # RViz
    rviz_config_file = (
        get_package_share_directory("moveit_servo") + "/config/manipulator_rviz_confi.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
    ...
    container = ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                ...
                parameters=[{"child_frame_id": "/world", "frame_id": "/dummy"}],
            ),
            ComposableNode(
                package="moveit_servo",
